...
```bash  theme={null}
asc submit create --app "123456789" --version "1.2.3"
```

<Note>
  Use `--confirm` to skip confirmation prompts in scripts: `asc submit create --app "123456789" --version "1.2.3" --confirm`
</Note>
