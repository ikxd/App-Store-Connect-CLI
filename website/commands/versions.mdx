...
<ParamField path="--include" type="string">
  Include related resources (comma-separated): `ageRatingDeclaration`, `appStoreReviewDetail`, `appStoreVersionLocalizations`, `build`, `appStoreVersionPhasedRelease`, `routingAppCoverage`, `appStoreVersionSubmission`
</ParamField>
